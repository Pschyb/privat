...
from rose2_core.rose_v1_repo.fft_structure_extraction import FFTStructureExtraction as structure_extraction

import rose2_core.rose_v1_repo.fft_structure_extraction
...
def main(path_to_image, path_to_folder, filter_level, par):
    ...
    # TODO adjust this part of the src
